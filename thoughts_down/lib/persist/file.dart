...
void main() async {
  ...
  final database = openDatabase(
    ...
    onCreate: (db, version) {
      ...
      return db.execute(
        'CREATE TABLE thought(id INTEGER PRIMARY KEY, create_time DateTime, text text)',
      );
    },
  ...
  Future<void> insertThought(Thought thought) async {
    ...
    await db.insert("thought", thought.toMap());
  }
  ...
  insertThought(Thought(createTime: DateTime.now(), text: "text"));
  print(thoughts());
}
